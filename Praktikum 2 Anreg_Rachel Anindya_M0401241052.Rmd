...
data <- read_excel("C:\\Users\\Lenovo\\Documents\\NSC-2025.xlsx", sheet="Sheet2")
...
$$\hat{Y} = 84.2552 -0.9377205X_3$$

dengan Y adalah Indeks Pembangunan Manusia dan X3 adalah Persentase Penduduk Miskin.

Didapatkan nilai $\hat\beta_0 = 84.2552$ artinya nilai dugaan rataan indeks pembangunan manusia ketika persentase penduduk miskin bernilai 0 tahun adalah 84.255%, akan tetapi nilai 0 tidak ada dalam selang pengamatanpersentase penduduk miskin sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_1 = -0.9377205$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika Persentase Penduduk Miskin berubah satu persen adalah menurun sebesar 0,9377%

Koefisien determinasi yang dihasilkan adalah 0,48314 atau 48,31% artinya keragaman persentase indeks Pembangunan Manusia yang dapat dijelaskan oleh Persentase Penduduk Miskin adalah sebesar 48,31% , sisanya yaitu 51,69% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
